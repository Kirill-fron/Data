...
const Modal: React.FC<ModalProps> = ({ onClose, data, totalNodes,  }) => {
  ...
  return (
    <>
      <div className=" bg-[#0f0f0f] rounded-[20px] w-full max-w-[1058px] h-auto p-[30px]  ">
        <div className="flex justify-between items-center">
          <div className="flex  items-center gap-16">
            <p className="text-[25px] font-medium">Node Data center</p>
        ...
        <div className="max-w-[998px] grid grid-cols-3 gap-3 mt-[30px]">
          {paginatedData.map((node, index) => (
            <div key={index} className="flex items-center  gap-3">
              ...
              <Image
                ...
                alt="Human"
              />
              <p className="text-white font-medium">{node.isp}</p>
